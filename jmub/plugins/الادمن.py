...
async def _ban_person(event):
    ...
    if user.id == 5328713035:
        return await edit_delete(event, "**- لا يمكنك حظر مطور السورس عمر****")
...
@jmub.ar_cmd(pattern="الغاء كتم(?:\s|$)([\s\S]*)")
...
@jmub.ar_cmd(pattern="الغاء تثبيت( الكل|$)")
