...
ROE = """** اهلا بك عزيزي المستخدم في قائمة اوامر القرش
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("اوامري") and event.query.user_id == jmub.uid:
            buttons = [
                [Button.inline("معلومات القرش", data="AOMRDB")],
                [
...
async def varssett(event):
    await event.edit(
        """اهلا بك في قائمة اوامر سورس القرش هذه بعض المعلومات عن القرش:

- سورس القرش يمتلك اكثر من 100 أمر 
- القرش هو افضل سورس عربي يتميز بالحماية
...
* يمكنك الحصول على  كليشة جاهزة من هذه القناة @L_H_V
ملاحظة : يمكنك استخدام الاوامر في اي دردشة او محادثة
اوامر فارات سورس القرش @L_H_V""",
        buttons=[
            [Button.inline("رجوع", data="pmvars")],
