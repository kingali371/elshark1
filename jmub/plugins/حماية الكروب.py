...
@jmub.ar_cmd(pattern="قفل ?(.*)", groups_only=True, require_admin=True)
async def _(event):
...
@jmub.ar_cmd(pattern="الاعدادات$", groups_only=True)
async def _(event):
    res = ""
...
@jmub.ar_cmd(incoming=True, forword=None)
